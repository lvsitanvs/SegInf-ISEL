...
Numa sessão utilizador *u<sub>4</sub>* , o conjunto total de permissões que podem existir são Pu<sub>4</sub> = {p1, p2 e p3} uma vez que na UA o *u<sub>4</sub>* é (S)upervisor e segunda as regras de RH, este herda de {D ⪯ S, T ⪯ S e M ⪯ D, M ⪯ D}.
